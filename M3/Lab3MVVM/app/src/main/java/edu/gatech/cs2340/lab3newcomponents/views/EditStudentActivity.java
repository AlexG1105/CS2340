...
public class EditStudentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        standingSpinner = findViewById(R.id.standing_spinner);
        ...
        //turns out that I can't just use the values() for the string array
        ClassStanding[] standingArray = ClassStanding.values();
        String[] standingStringArray = new String[standingArray.length];
        for (int i = 0; i < standingArray.length; i++) {
            standingStringArray[i] = standingArray[i].name();
        }

        ArrayAdapter<String> standingAdapter = new ArrayAdapter<>(this, android.R.layout.simple_spinner_item, standingStringArray);
        ...
        if (getIntent().hasExtra(CourseDetailActivity.STUDENT_DATA)) {
            ...
            standingSpinner.setSelection(student.getClassStanding().ordinal());
            editing = true;
    ...
    public void onAddPressed(View view) {
        ...
        student.setClassStanding(ClassStanding.valueOf((String) standingSpinner.getSelectedItem()));
        System.out.println(student.getClassStanding().name());
